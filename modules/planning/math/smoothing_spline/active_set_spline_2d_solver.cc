...
Spline2dKernel* ActiveSetSpline2dSolver::mutable_kernel() {
    AINFO<<"(DMCZP) EnteringMethod: ActiveSetSpline2dSolver::mutable_kernel";
 return &kernel_; }

Spline2d* ActiveSetSpline2dSolver::mutable_spline() {
...
// extract
const Spline2d& ActiveSetSpline2dSolver::spline() const {
